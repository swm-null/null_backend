...
public record FindPasswordRequest(
    ...
    @Schema(description = "새 비밀번호", example = "password123!", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "이메일 인증 여부", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
